...
from ultimo.core import ASource, APipeline, APipelineFlow, asynchronize, Returned, Consumed, P, Async, Func
...
class Apply(APipeline[Returned, Consumed]):
    ...
    def __init__(self, fn: Callable[[Consumed], Returned], args: tuple[Any, ...] = (), kwargs: dict[str, Any] = {}, source: ASource[Consumed] | None = None): ...
...
class Filter(APipeline[bool, Consumed]):
    ...
    def __init__(self, filter: Func | Async, source: ASource[Consumed] | None = None): ...


class Debounce(APipeline[Returned, Returned]):
    """Pipeline that stabilizes values emitted during a delay."""

    def __init__(self, delay: float = 0.01, source: ASource[Returned] | None = None): ...
...
class EWMA(APipeline[Returned, Returned]):
    ...
    def __init__(self, weight: float = 0.5, source: ASource[Returned] | None = None): ...


def pipe(fn: Callable[[Consumed], Returned]) -> Callable[[], Apply[Returned, Consumed]]: ...
